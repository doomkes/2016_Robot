...
// */
//void ADXRS450_Gyro_4967::Calibrate() {
//  Wait(0.1);
//
...
//
//  m_centerValue = m_spi.GetAccumulatorAverage();
//
//  m_spi.SetAccumulatorCenter(m_centerValue);
//  m_spi.ResetAccumulator();
//  printf ("Center Value %i \n",m_centerValue);
//}
//
///**
// * Gyro constructor on onboard CS0.
// */
//ADXRS450_Gyro_4967::ADXRS450_Gyro_4967() : ADXRS450_Gyro_4967(SPI::kOnboardCS0) {}
//
///**
...
// */
//ADXRS450_Gyro_4967::ADXRS450_Gyro_4967(SPI::Port port) : m_spi(port) {
...
//}
//
//uint16_t ADXRS450_Gyro_4967::ReadRegister(uint8_t reg) {
...
// */
//float ADXRS450_Gyro_4967::GetAngle() const {
...
// */
//double ADXRS450_Gyro_4967::GetRate() const {
//  return (double)m_spi.GetAccumulatorLastValue() * kDegreePerSecondPerLSB;
//}
//
//
//void ADXRS450_Gyro_4967::NullAdjust(bool begin){
//	static  int64_t beginValue;
//	static uint32_t beginCount;
//	int64_t value;
//	uint32_t count;
//
//	if (begin){ // grab beginning accumulator value and count
//		m_spi.GetAccumulatorOutput(beginValue, beginCount);
//		printf ("Begin Value %i Count %u \n", beginValue, beginCount);
//	}
//	else{
//		m_spi.GetAccumulatorOutput(value, count);
//		printf ("Value %i Count %ul \n", value, count);
//		int64_t valueDiff = value - beginValue;
//		uint32_t countDiff = count - beginCount;
//		if (countDiff > 5000){
//				m_centerValue = valueDiff / countDiff;
//		}
//		else{
//			m_centerValue = m_centerValue*(5000-countDiff)/5000 + valueDiff*countDiff/5000;
//		}
//		//m_spi.SetAccumulatorCenter(m_centerValue);
//		printf("Value Diff %i  Count Diff %i New Null value %i\n",valueDiff,countDiff, m_centerValue);
//	}
//
//}
//
